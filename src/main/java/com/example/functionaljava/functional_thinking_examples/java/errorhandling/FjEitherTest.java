package com.example.functionaljava.functional_thinking_examples.java.errorhandling;
...
public void test_divide_romans_success() {
    Either<NumberFormatException, Either<ArithmeticException, Double>> result = FjRomanNumeralParser.divideRoman("IV", "II");
